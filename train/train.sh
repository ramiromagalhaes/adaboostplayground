#!/bin/sh
./train_vj_classifier     /mnt/faces/faces.pgm /mnt/fundo/background-v2.pgm /mnt/features/haarclassifiers-original.txt  /mnt/classifiers/strongHypothesis-vj.txt     200;
